...
-- Peixe Palhaço
INSERT INTO tb_animal (scientific_name, common_name, habitat, geographic_distribution, origin_region, locomotion, type_food, hope_life, type_reproduction, fur_pattern, main_colors, average_length, average_width, average_height, breed, period_pregnancy, url_img, additional_details, taxonomy_id)
VALUES ('Amphiprion ocellaris', 'Peixe Palhaço', 'Recifes de corais', 'Região Indo-Pacífica', 'Região Indo-Pacífica', 'AQUATIC', 'OMNIVORE', '5-10 anos', 'SEXUAL', 'Escamosa', 'Laranja e branco', '10-18 cm', NULL, NULL, NULL, NULL, 'https://images.pexels.com/photos/128756/pexels-photo-128756.jpeg?auto=compress&cs=tinysrgb&w=600', 'Peixe laranja com listras brancas mundialmente famoso', 1);
